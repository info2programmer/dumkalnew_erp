...
<div class="row">
    ...
    <div class="row">
        ...
        <form id="form8" name="emp_dtls" action="<?php echo base_url();?>index.php/report/Student/SearchTotal" method="post" enctype="multipart/form-data" target="_blank" onsubmit="return validate_group()">
            ...
            <fieldset>
                ...
                <legend><b style="font-size:26px;">Select Total Student</b></legend><div class="form-group">
            ...
            <div class="form-group">
                ...
                <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchTotal" class="btn btn-primary">Submit</button>            

                <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchTotal_excel" class="btn btn-success">Excel Download</button>
