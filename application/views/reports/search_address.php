...
<div class="row">
    ...
    <div class="row">
        ...
        <form id="form8" name="emp_dtls" action="<?php echo base_url();?>index.php/report/Student/SearchAddress" method="post" enctype="multipart/form-data" target="_blank" onsubmit="return validate_group()">
            ...
            <fieldset>
                ...
                <legend><b style="font-size:26px;">Search  Address Sheet</b></legend>
           ...
           <div class="form-group">
            ...
            <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchAddress" class="btn btn-primary">Submit</button>

            <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchAddress_excel" class="btn btn-success">Excel Download</button>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <h4 class="alert alert-info">Search Address</h4>
