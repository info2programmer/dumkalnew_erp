...
<html >
   ...
   <body>
      ...
      <div class="container">
        ...
        Selected Employee <input type='text' id='getcnt' class="getcnt rounded_new_option" style="width:30px; text-align:center; font-weight:bolder;" readonly="readonly">
        <a onClick="javascript:checkAll(true);" href="javascript:void();"><button class="btn btn-primary btn-xs">Check All</button></a> / 
        <a onClick="javascript:checkAll(false);" href="javascript:void();"><button class="btn btn-danger btn-xs">Uncheck All</button></a>
        <div class="pull-right">
        <a href="#" onClick="getCheckedCheckboxesFor()"><button class="btn btn-success btn-xs"><i class="fa fa-comment"></i> Send Messages</button></a>
       	 <!--<a href="#" onclick="getCheckedCheckboxesFor()">Print ID Card</a>&nbsp;&nbsp;&nbsp;-->
        <a href="#" onClick="getCheckedCheckboxesForlibrary()"><button class="btn btn-success btn-xs"><i class="fa fa-print"></i> Print library Card</button></a>
        </div>
        </div>
