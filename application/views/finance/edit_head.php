...
<div class="container">
         ...
         <div class="col-md-6">
            <form name="emp_dtls" action="<?php echo base_url();?>Finance/financeDetails/update_head" method="post" enctype="multipart/form-data">
            <input type="hidden" name="hid" value="<?php echo $editdata[0]['id'];?>" />
            <?php 
			$depid = $this->uri->segment(6);
			$actid = $this->uri->segment(7);
			$uid = $this->uri->segment(8);
			?>
    ...
    <h3 class="alert alert-info text-center"><strong class="text-uppercase"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Add Fee Head </strong></h3>
        ...
        <?php endif; ?>
              ...
              <select name="type" id="type" required="" class="form-control">
                <option value="">Select Type</option>
                    <option value="Income" <?php if($editdata[0]['type']=='Income'){?>selected<?php } ?>>Income</option>
                    <option value="Expense" <?php if($editdata[0]['type']=='Expense'){?>selected<?php } ?>>Expense</option>
                </select>
            ...
            <div class="form-group">
               ...
               <select name="term" id="term" required="" class="form-control">
                <option value="">Select Term</option>
                    <option value="Daily" <?php if($editdata[0]['term']=='Daily'){?>selected<?php } ?>>Daily</option>
                    <option value="Weekly" <?php if($editdata[0]['term']=='Weekly'){?>selected<?php } ?>>Weekly</option>
                    <option value="Monthly" <?php if($editdata[0]['term']=='Monthly'){?>selected<?php } ?>>Monthly</option>
                    <option value="Half Yearly" <?php if($editdata[0]['term']=='Half Yearly'){?>selected<?php } ?>>Half Yearly</option>
                    <option value="Yearly" <?php if($editdata[0]['term']=='Yearly'){?>selected<?php } ?>>Yearly</option>  
                </select>
            </div>
            <div class="form-group">
                <label for="">Head Name</label>
                <input type="text" name="name" id="name" required="" class="form-control" value="<?php echo $editdata[0]['name'];?>">
            </div>
            <div class="form-group">
                <label for="">Note</label>
                <input type="text" name="note" id="note" required="" class="form-control" value="<?php echo $editdata[0]['note'];?>">
            </div>
            <div class="form-group">
                <label for="">Favour In</label>
                 <select name="favour" id="favour" required="" class="form-control">
                <option value="">Select Favour</option>
                    <option value="Student" <?php if($editdata[0]['favour']=='Student'){?>selected<?php } ?>>Student</option>
                    <option value="Office" <?php if($editdata[0]['favour']=='Office'){?>selected<?php } ?>>Office</option>
