  ...
  <tr>
    <td width="655" height="850" align="center" valign="top"><table width="640" border="1" cellspacing="0" cellpadding="3" style="border-collapse:collapse;">
      ...
      <tr>
        ...
        <span class="style3"><?php if(($aply_data[0]['sub_from']!='')||($aply_data[0]['sub_to']!='')){echo '<br>Subject Changed';}?></span>
        </td>
        </tr>
        <tr>
        <td width="139" height="70" align="left" valign="middle"><span class="style12">Form No</span></td>
        <td height="70" class="style10"><?php echo $aply_data[0]['apply_form_number'];?></td>
        <td height="70" colspan="2" class="style12">
        <table width="190" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
          <tr>
            <td width="190" height="60" align="center" valign="middle"><img src="<?php echo base_url();?>index.php/transfer/main/show_barcode/<?php echo $aply_data[0]['apply_form_number'];?>" alt="" /></td>
          </tr>
        </table></td>
        </tr>
      <tr>
        ...
        <td width="116" height="25" class="style10"><?php echo $aply_data[0]['adm_date'];?></td>
      </tr>
      <tr>
        ...
        <td height="25" class="style10"><?php echo $aply_data[0]['adm_tran_no'];?></td>
      </tr>
      <tr>
        <td width="139" height="25" align="left" valign="middle"><span class="style12">Amount Received</span></td>
        <td width="265" height="25" class="style10">Rs. <?php echo $aply_data[0]['adm_pay_amnt'];?>.00 /-</td>
      ...
      <tr>
        ...
        <td height="25" colspan="3" class="style10">online admission for <?php echo $stu_data[0]['stream_name']." (".$aply_data[0]['subject1'].")";?> 
		<?php if($aply_data[0]['sub_from']!=''){$sel_sub_from=$this->db->query('select * from td_student_application where apply_form_number="'.$aply_data[0]['sub_from'].'"')->row();echo ' From '.$sel_sub_from->subject1;} ?></td>
        </tr>
      <tr>
