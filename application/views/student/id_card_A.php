...
.head{
	...
	font-size:9px;
	font-weight:bold;}
body .page > table{page-break-inside:avoid;}	
    ...
    <td width="332" height="207" align="center" valign="top"><table width="325" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="2" align="left" valign="top"><table width="210" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="40" align="left" valign="bottom"><img src="<?php echo base_url();?>index.php/main/show_barcode/<?php echo $card['student_id'];?>" alt="" class="barcode" /></td>
          </tr> 
          <tr>
            <td>Name : <?php echo $card['name'];?></td>
          </tr>
          <tr>
            <td><?php if($card['sex']=='M'){echo 'S';}else{echo 'D';}?>
              /O : <?php echo $card['father_name'];?></td>
          </tr>
          <tr>
            <td>Address : <?php echo $card['vill'];?>, <?php echo $card['po'];?>, <?php echo $card['ps'];?></td>
          </tr>
          <tr>
            <td>From <?php echo date('d-M-Y')?> To 30-Jun-<?php echo date('Y')?></td>
          </tr>
          </table></td>
      </tr>
      <tr>
