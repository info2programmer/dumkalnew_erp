...
<head>
	...
	@media print{@page {size: landscape}}
        ...
        .page {height: 12in; width: 18in; padding: 2mm}
        ...
        .roll {margin-left: 49mm; margin-top: -3.5mm; width: 40mm; color: maroon; font-size: 12px; font-weight: bold;}
...
$i++;
    ...
    <div class="card">
        ...
        <div class="roll">Roll No <?php echo $card['roll'];?> <span style="color:#FF0000"> (Duplicate)</span></div>
