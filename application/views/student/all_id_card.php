  ...
  padding-top: 0px !important;
   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="col-md-6">
            <form name="emp_dtls" action="<?php echo base_url();?>Student/StudentDetails/search_student_idCards" method="post" enctype="multipart/form-data">
            <?php 
    ...
    <h3 class="alert alert-info text-center"><strong class="text-uppercase"> <i class="fa fa-id-card"></i> Student ID Card / library Card </strong></h3>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <h4 class="alert alert-info">Student ID Card</h4>
