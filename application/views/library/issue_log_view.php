    ...
    <body>
        ...
        <h3 class="text-on-pannel text-primary"><strong class="text-uppercase"> Issue Books Logs </strong></h3>
        <?php// foreach($result as $result) { ?>
                  <div class="form-group">
                <label for=""> Emp/Stud ID</label>
    ...
    <div class="jumbotron alert alert-warning">
        ...
        <div class="list-item">
            ...
            <div class="box">
				...
				echo ($books->type == 'S')?'<strong>Student Id: </strong>'.$books->member_id:'<strong>Employee Id: </strong>'.$books->member_id; 
				...
				echo ($books->type == 'S')?'<strong>Student Name: </strong>'.$books->member_name:'<strong>Employee Name: </strong>'.$books->member_name; 
            ...
            <div class="box">               
                ...
                <span><?php echo "<strong>Issue Date : </strong>".$books->issue_date; ?></span>

                <span><?php echo "<strong>Return Date: </strong>".$books->due_date; ?></span>

            </div>

            <div class="box">               

                <span><?php echo "<strong>Issue Type : </strong>".$books->issue_type; ?></span>

                <span><?php echo "<strong>Member Type : </strong>".$books->type; ?></span>
...
<?php if (empty($default_log)){?>

<div align="center" style="width:100%; position:absolute;">No Data Found</div>

<?php }else {?>

<?php foreach($default_log as $books) { ?>
    ...
    <div class="row-full">
        ...
        <div class="list-item">
            ...
            <div class="box">
				...
				echo ($books->type == 'S')?'Student Id: '.$books->member_id:'Employee Id: '.$books->member_id; 
				...
				echo ($books->type == 'S')?'Student Name: '.$books->member_name:'Employee Name: '.$books->member_name; 
            ...
            <div class="box">               
                ...
                <span><?php echo "Issue Date : ".$books->issue_date; ?></span>

                <span><?php echo "Return Date: ".$books->due_date; ?></span>

            </div>

            <div class="box">               

                <span><?php echo "Issue Type : ".$books->issue_type; ?></span>

                <span><?php echo "Member Type : ".$books->type; ?></span>
