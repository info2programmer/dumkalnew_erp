    ...
    <body>
        ...
        <h3 class="text-on-pannel text-primary"><strong class="text-uppercase"> Returned Books Log </strong></h3>
    ...
    <div class="jumbotron alert alert-info">
          <div class="list-item">
            ...
            <div class="box">
                ...
                <span><?php echo "<strong>Acc. No.: </strong>Acc. No.: ".$books->acc_no; ?></span>
            ...
            <div class="box">               
                ...
                <span><?php echo "<strong>Return Date : </strong>".$books->payment_date; ?></span>
