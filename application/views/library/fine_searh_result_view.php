    ...
    <body>
        ...
        <h3 class="text-on-pannel text-primary"><strong class="text-uppercase"> Fine Details Log </strong></h3>
...
<?php foreach($search_book as $books) { ?>
    ...
    <div class="jumbotron alert alert-info">
          <div class="list-item">
            <div class="box">
                <span><?php echo "<strong>Student Id: </strong>".$books->member_id; ?></span>
            </div>
            <div class="box">               
                <span><?php echo "<strong>Student Name: </strong>".$books->member_name; ?></span>
            </div>
            <div class="box">               
                <span><?php echo "<strong>Amount : </strong>".$books->amount; ?></span>
            </div>
            <div class="box">               
                <span><?php echo "<strong>Payment Date : </strong>".$books->payment_date; ?></span>
            </div>
        </div>
    </div>
