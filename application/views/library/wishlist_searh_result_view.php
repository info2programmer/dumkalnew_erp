    ...
    <body>
        ...
        <h3 class="text-on-pannel text-primary"><strong class="text-uppercase"> Wishlist Details </strong></h3>
...
<?php foreach($search_book as $books) {   $book_desc = $this->db->query('select * from tb_library_books where acc_no="'.$books->acc_no.'"')->row();?>
    ...
    <div class="jumbotron alert alert-info">
        <div class="list-item">
            ...
            <div class="box">               
                <span><?php echo "<strong>Wishlist Date : </strong>".$books->wishlist_date; ?></span>
