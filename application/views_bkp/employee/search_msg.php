...
<div class="row">
    ...
    <div class="row">
        <form name="emp_dtls" action="<?php echo base_url();?>index.php/employee/employeeDetails/search_msg_details" method="post" enctype="multipart/form-data">
            
           
            <fieldset>
            <legend><b style="font-size:26px;">Search Sms</b></legend>
            <div class="form-group">
                <label for="">Date</label>
                <input type="date" name="txt_date" id="datepicker" class="form-control"/>
            </div>
            OR
            <div class="form-group">
                <label for="">Emp Name</label>
                <select name="txt_name" id="txt_name" class="form-control">
