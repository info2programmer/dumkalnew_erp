...
<div class="container">
	<div class="row">
        ...
        <h4 class="alert alert-info">Modify User</h4> 
        		<div class="alert alert-success">
                      <form class="form-horizontal" action="" method="post" name="userForm" id="userForm">
                        <?php if($this->session->flashdata('user_modify_success_msg')!=''){?> 
                        <div class="alert alert-success">
                          <?php echo $this->session->flashdata('user_modify_success_msg') ; ?>
                        </div>
                      <?php } ?>
                      <div class="form-group">
                        <label class="control-label col-sm-2" for="user">Name of the User :</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="name" id="name" value="<?php if($user_details->name!='') echo $user_details->name; ?>" autofocus>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="mobile" name="mobile" value="<?php if($user_details->mobile!='') echo $user_details->mobile; ?>" autofocus>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="email" name="email" value="<?php if($user_details->email!='') echo $user_details->email; ?>" autofocus>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="username" value="<?php if($user_details->username!='') echo $user_details->username; ?>" name="username" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="user_id_auto" value="<?php if($user_details->user_id_auto!='') echo $user_details->user_id_auto; ?>" name="user_id_auto" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="password" value="<?php if($user_details->original_password!='') echo $user_details->original_password; ?>" name="password">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="conf_password" value="<?php if($user_details->original_password!='') echo $user_details->original_password; ?>" name="conf_password">
                        ...
                        <div class="col-sm-10">
                          <select  class="form-control" id="department" name="department">
                            ...
                            <?php if(!empty($deaprtments)){ foreach ($deaprtments as $key => $value) { ?>
                                <option value="<?php echo $value->departmet_id ; ?>" <?php if($value->departmet_id==$user_details->department_id) echo "selected=selected"; ?>><?php echo $value->department_name ; ?></option>
                           <?php } ?>    
                      ...
                      <div class="form-group"> 
                        <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-plus-circle"></i> Modify User</button>
                          <a href="<?php echo base_url() ?>createuser" class="btn btn-success btn-lg"><i class="fa fa-arrow-left"></i>&nbsp;Back to Add User</a>
                        </div>
                      </div>
                    </form>
                 </div>
