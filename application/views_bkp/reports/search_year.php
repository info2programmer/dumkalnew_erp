...
<div class="row">
    ...
    <div class="row">
        ...
        <form id="form8" name="emp_dtls" action="<?php echo base_url();?>index.php/Report/Student/SearchStdList" method="post" enctype="multipart/form-data" target="_blank" onSubmit="return validate_group()">
           ...
           <div class="form-group">
                ...
                <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchStdList" class="btn btn-primary">Submit</button>                

                <button type="submit" formaction="<?php echo base_url();?>index.php/Reports/ReportsDetails/SearchStdList_excel" class="btn btn-success">Excel Download</button>
