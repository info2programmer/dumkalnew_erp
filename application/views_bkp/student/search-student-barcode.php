  ...
  padding-top: 0px !important;
   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="col-md-4">
            <form name="barcode_form" action="<?php echo base_url();?>student/studentDetails/student_profile_barcode" method="post" enctype="multipart/form-data">
              <?php if(isset($msg))?>
            <?php 
    ...
    <h3 class="alert alert-info text-center"><strong class="text-uppercase"> <i class="fa fa-barcode"></i> Search Student </strong></h3>
