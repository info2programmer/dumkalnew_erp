...
<div class="container">
	<div class="row">
        ...
        <h4 class="alert alert-info">Modify Function</h4> 
        		<div class="alert alert-success">
                      ...
                      <?php } ?>
                      <?php if($this->session->flashdata('function_error_msg')!=''){?> 
                        <div class="alert alert-success">
                          <?php echo $this->session->flashdata('function_error_msg') ; ?>
                        </div>
                      <?php } ?>
                      <div class="form-group">
                        <label class="control-label col-sm-2" for="email">Name of the Function :</label>
                        <div class="col-sm-10">
                          <input type="text" value="<?php if(!empty($details)) echo $details->functionn_name;  ?>" class="form-control" id="functionn_name" name="functionn_name" placeholder="Eg : View" autofocus>
                      ...
                      <div class="form-group"> 
                        <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-plus-circle"></i> Modify Function</button>
                          <a href="<?php echo base_url() ?>createfunction" class="btn btn-success btn-lg"><i class="fa fa-arrow-left"></i>&nbsp;Back to Add Function</a>
                        </div>
                      </div>
                    </form>
                 </div>
